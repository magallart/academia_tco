    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <span class="titulo-superior center">Nuestra familia</span>
                <h2 class="text-center">Conoce al equipo de ATCO</h2>
                <p class="text-center">Estamos orgullosísimos del equipazo que hemos conseguido formar en ATCO. Unos han venido, otros se han ido pero los que estamos hoy en día en la academia somos los que vamos a luchar para que consigas tus objetivos y dar el 100% no es una opción sino un deber.</p>
                <p>A continuación puedes conocer el equipo humano que da vida a la Academia Tus Cursos Online. Te dejamos nuestras redes sociales por si quieres conocernos más a fondo y preguntarnos cualquier cosa. ¡Te esperamos!</p>
            </div>
        </div>
    </div>
</section>

<section class="equipo-cards">
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-8">
                            <div class="card-body">
                                ...
                                <div class="social">
                                    ...
                                    <a href="https://es-es.facebook.com/" target="_blank" alt="Foto de Marisa López"><img src="../../img/facebook-icono.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8 col-sm-8 col-8">
                            <div class="card-body">
                                ...
                                <div class="separador"></div>
                                <p>Mente brillante que piensa y coordina toda la academia. ATCO es como es en gran medida gracias a ella. Siempre tiene un plan b.</p>
                                <div class="social">
                                    <a href="https://es.linkedin.com/" target="_blank" alt="Foto de Marisa López"><img src="../../img/linkedin-icono.png" alt=""></a>
                                    <a href="https://twitter.com/?lang=es" target="_blank" alt="Foto de Marisa López"><img src="../../img/twitter-icono.png" alt=""></a>
                                    <a href="https://es-es.facebook.com/" target="_blank" alt="Foto de Marisa López"><img src="../../img/facebook-icono.png" alt=""></a>
