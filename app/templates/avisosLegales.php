...
<div class="container legales">
    <div class="row">
        <div class="col">
            <h1 class="text-center my-5">Avisos Legales</h1>

            <p>Academia Tus Cursos Online S.L., responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.</p>

            <p>Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación. </p>

            <p>Academia Tus Cursos Online S.L. se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de Academia Tus Cursos Online S.L.</p>

            <h2>
                <ion-icon name="play"></ion-icon> Datos identificativos
            </h2>

            <ul>
                <li><span>Denominación social</span>: Academia Tus Cursos Online S.L.</li>
                <li><span>Nombre comercial</span>: Academia Tus Cursos Online (ATCO).</li>
                <li><span>CIF</span>: 46025040</li>
                <li><span>Domicilio</span>: C/ D'Alberic, 18, 46008 València, Valencia.</li>
                <li><span>e-mail</span>: info@atco.com</li>
            </ul>

            <h2>
                <ion-icon name="play"></ion-icon> Objeto
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Privacidad y tratamiento de datos
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Propiedad industrial e intelectual
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Obligaciones y responsabilidades del usuario del espacio web
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Responsabilidades
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Hipervínculos
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Protección de datos
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Cookies
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Declaraciones y garantías
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Fuerza mayor
            </h2>
            ...
            <h2>
                <ion-icon name="play"></ion-icon> Resolución de controversias, ley aplicable y jurisdicción
            </h2>
